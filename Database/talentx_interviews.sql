...
CREATE TABLE `interviews` (
  ...
  `interview_type` enum('PHONE_SCREEN','VIDEO','ONSITE','TECHNICAL','HR','PANEL','FINAL') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `recommendation` enum('STRONG_HIRE','HIRE','MAYBE','NO_HIRE','STRONG_NO_HIRE') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_interview_date` (`scheduled_date`),
