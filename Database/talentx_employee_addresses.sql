...
CREATE TABLE `employee_addresses` (
  `employee_address_id` bigint NOT NULL AUTO_INCREMENT,
  `employee_id` bigint NOT NULL,
  `address_type` enum('HOME','WORK','MAILING','OTHER') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_emp_addr` (`employee_id`),
  CONSTRAINT `fk_emp_addr_emp` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE
